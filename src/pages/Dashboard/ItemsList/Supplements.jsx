...
import { IonInput, IonList, IonButton, IonIcon, IonLabel, IonItem, IonAvatar, IonSelectOption, IonSelect, IonRadioGroup, IonListHeader, IonDatetime, IonToggle, IonCheckbox} from '@ionic/react';
      ...
      <div id="myDIVSuppl">
        <IonList>
          <IonItem className="trashButton" color="danger">
            ...
            <IonIcon className="arrowDashItem" icon={arrowDropdownCircle} onClick={() => accor("myDIVAjoutSupp1")}/>
          </IonItem>
          <div id = "myDIVAjoutSupp1">
              <IonList>
                ...
                <IonItem>
                  ...
                  <IonInput className="inputSuppConsom"></IonInput>
                  <IonSelect value={""} placeholder="Unité" className="inputSuppConsom">
                    <IonSelectOption value="oz">Oz</IonSelectOption>
                    <IonSelectOption value="ml">Ml</IonSelectOption>
                    <IonSelectOption value="unite">Unité</IonSelectOption>
                  </IonSelect>
                </IonItem>
                <IonList>
                  <IonRadioGroup>
                ...
                <IonItem>
                  ...
                  <ion-datetime value="2021-10-01T15:43:40.394Z" display-timezone="utc"></ion-datetime>
                </IonItem>
                <IonItem>
                  <IonLabel color="light" >Date de fin</IonLabel>
                  <IonDatetime value="2021-12-10T15:43:40.394Z" display-timezone="utc"></IonDatetime>
                </IonItem>
                <IonItem>
                  <IonLabel slot = "start" color="light">Actif</IonLabel>
                ...
                <IonItem>
                  ...
                  <IonLabel color="light" slot="start">Mardi</IonLabel>
                  <IonCheckbox color="primary" checked ></IonCheckbox>
                </IonItem>
                <IonItem>
                  <IonLabel color="light">Mercredi</IonLabel>
                  <IonCheckbox color="primary" checked slot="start" ></IonCheckbox>
                  <IonLabel color="light" slot="start">Jeudi</IonLabel>
                  <IonCheckbox color="primary" checked ></IonCheckbox>
                </IonItem>
                <IonItem>
                  <IonLabel color="light" >Vendredi</IonLabel>
                  <IonCheckbox color="primary" checked slot="start" ></IonCheckbox>
                  <IonLabel color="light" slot="start">Samedi</IonLabel>
                  <IonCheckbox color="primary" checked ></IonCheckbox>
                </IonItem>
                <IonItem>
                ...
                <IonItem>
                  ...
                  <IonDatetime display-format="h:mm A" picker-format="h:mm A" value="1990-02-19T11:00Z"></IonDatetime>
                  <IonDatetime display-format="h:mm A" picker-format="h:mm A" value="1990-02-19T14:00Z"></IonDatetime>
                </IonItem>
                <IonItem>
                  <IonLabel color="light" >Midi</IonLabel>
                  <IonDatetime display-format="h:mm A" picker-format="h:mm A" value="1990-02-19T17:00Z"></IonDatetime>
                  <IonDatetime display-format="h:mm A" picker-format="h:mm A" value="1990-02-19T19:00Z"></IonDatetime>
                </IonItem>
                <IonItem>
                  <IonLabel color="light" >Soir</IonLabel>
                  <IonDatetime display-format="h:mm A" picker-format="h:mm A" value="1990-02-19T00:00Z"></IonDatetime>
                  <IonDatetime display-format="h:mm A" picker-format="h:mm A" value="1990-02-19T03:00Z"></IonDatetime>
                </IonItem>
                </IonList>
                <IonItem>
